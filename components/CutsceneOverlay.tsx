...
export default function CutsceneOverlay() {
  ...
  > = {
    ...
    angel_investment: {
      ...
      body: `Peter Thiel writes you a check.\n\n+$200,000 in the bank.\n\n"Zero to one. Now execute."`,
      emoji: "✍️",
    ...
    series_a_offer: {
      title: "Series A Offer! 🚀",
      body: `Andreessen Horowitz is leading your Series A.\n\n+$5,000,000.\n\n"Software is eating the world. Now go eat your market."`,
      emoji: "📈",
      color: "border-green-500/50",
      buttonText: "Continue",
      onButton: dismissCutscene,
    ...
    term_sheet: {
      title: "Term Sheet! 📄",
      body: `You have a term sheet on the table.\n\n+$5,000,000.\n\nThe dream is becoming real.`,
      emoji: "📄",
      color: "border-green-500/50",
      buttonText: "Continue",
      onButton: dismissCutscene,
